package com.palash.parkinglot.services;

import com.palash.parkinglot.enums.SlotAllocationStrategyType;
import com.palash.parkinglot.enums.VehicleType;
import com.palash.parkinglot.exceptions.GateNotFoundException;
import com.palash.parkinglot.exceptions.ParkingLotNotFoundException;
import com.palash.parkinglot.factories.SlotAllocationStrategyFactory;
import com.palash.parkinglot.models.*;
...
public class TicketService {
    ...
    public Ticket issueTicket(String vehicleNumber,
        ...
        ParkingSlot assignedParkingSlot = slotAllocationStrategy.getParkingSlot(gate, vehicleType);
